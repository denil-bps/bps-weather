...
window.WeatherAppConfig = {
    ...
    weather: {
        apiKey: '57c8d2e4c8d8b4a8c23e1e46f7bf865f', // Working API key
...
window.WeatherAppConfig.utils = {
    ...
    validateApiKey(apiKey) {
        return apiKey && apiKey.length > 10 && !apiKey.includes('YOUR_OPENWEATHERMAP_API_KEY');
    },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Set up console log for API key status  
    if (WeatherAppConfig.utils.validateApiKey(WeatherAppConfig.weather.apiKey)) {
        console.log('✅ Weather API key configured and ready');
    } else {
        console.warn('⚠️ Using demo API key. For full functionality, get your free API key at: https://openweathermap.org/api');
    }
